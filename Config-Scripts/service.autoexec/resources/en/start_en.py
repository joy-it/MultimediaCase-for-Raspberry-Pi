...
with open("/storage/.kodi/addons/service.autoexec/autoexec.py","a") as log:
    log.write("os.system(\"kodi-send --action='RunScript(\\\"/storage/.kodi/addons/service.autoexec/resources/en/start_en.py\\\")'\")\n")
...
setSettings = xbmcgui.Dialog().yesno("Configuration","Do you want to activate the functions of the Multimedia Case?")
if setSettings == True:
    os.system("kodi-send --action='RunScript(\"/storage/.kodi/addons/service.autoexec/resources/en/settings_en.py\")'")
